...
import artifactsData from '@/assets/_gen_artifact'
...
// Use generated release metadata for new sets as well as legacy aliases.
for (const [key, data] of Object.entries(artifactsData) as [string, any][]) {
    if (data.name2) nameMap[key] = data.name2
}
