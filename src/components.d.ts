...
declare module '@vue/runtime-core' {
  export interface GlobalComponents {
    MiyousheImport: typeof import('./components/import/MiyousheImport.vue')['default']
    OptimalStatGainCurve: typeof import('./components/display/OptimalStatGainCurve.vue')['default']
