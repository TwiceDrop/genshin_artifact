...
pub const ALOY_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    hp: [848, 2201, 2928, 4382, 4899, 5636, 6325, 7070, 7587, 8339, 8856, 9616, 10133, 10899, 11674],
    atk: [18, 47, 63, 94, 105, 121, 136, 152, 163, 179, 190, 206, 217, 234, 287],
    def: [53, 137, 182, 272, 304, 350, 393, 439, 471, 517, 550, 597, 629, 676, 724],
