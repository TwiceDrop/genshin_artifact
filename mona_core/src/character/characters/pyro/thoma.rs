...
pub const THOMA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    hp: [866, 2225, 2872, 4302, 4762, 5478, 6091, 6806, 7266, 7981, 8440, 9156, 9616, 10331, 11046],
    atk: [17, 43, 56, 84, 93, 107, 119, 133, 142, 156, 165, 179, 188, 202, 253],
    def: [63, 162, 209, 313, 346, 398, 443, 495, 528, 580, 613, 665, 699, 751, 803],
