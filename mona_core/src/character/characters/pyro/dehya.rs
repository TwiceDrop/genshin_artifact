...
const DEHYA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    hp: [1220, 3165, 4212, 6302, 7045, 8106, 9097, 10168, 10912, 11993, 12736, 13829, 14573, 15675, 16789],
    atk: [21, 54, 71, 107, 119, 137, 154, 172, 185, 203, 216, 234, 247, 265, 325],
    def: [49, 127, 169, 252, 282, 325, 364, 407, 437, 480, 510, 554, 584, 628, 673],
