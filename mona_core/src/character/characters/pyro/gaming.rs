...
impl CharacterTrait for Gaming {
    const STATIC_DATA: CharacterStaticData = CharacterStaticData {
        ...
        hp: [957, 2460, 3175, 4755, 5264, 6054, 6732, 7523, 8031, 8821, 9329, 10120, 10628, 11419, 12209],
        atk: [25, 65, 84, 126, 139, 160, 178, 199, 212, 233, 246, 267, 281, 302, 379],
        def: [59, 151, 195, 293, 324, 373, 414, 463, 494, 543, 574, 623, 654, 703, 752],
