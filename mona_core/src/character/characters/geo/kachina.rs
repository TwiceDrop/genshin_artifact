...
impl CharacterTrait for Kachina {
    const STATIC_DATA: CharacterStaticData = CharacterStaticData {
        ...
        element: Element::Geo,
        hp: [989, 2541, 3281, 4914, 5439, 6256, 6956, 7773, 8299, 9115, 9640, 10457, 10982, 11799, 12615],
        atk: [18, 47, 60, 90, 100, 115, 128, 143, 152, 167, 177, 192, 202, 217, 272],
        def: [66, 171, 220, 330, 365, 420, 467, 522, 557, 612, 647, 702, 738, 792, 847],
