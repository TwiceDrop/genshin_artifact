...
impl CharacterTrait for Xilonen {
    const STATIC_DATA: CharacterStaticData = CharacterStaticData {
        ...
        element: Element::Geo,
        hp: [966, 2505, 3333, 4987, 5576, 6415, 7199, 8047, 8636, 9491, 10079, 10945, 11533, 12405, 13287],
        atk: [21, 56, 74, 111, 124, 142, 160, 178, 191, 210, 223, 243, 256, 275, 337],
        def: [72, 188, 250, 374, 418, 481, 540, 603, 647, 712, 756, 820, 865, 930, 996],
