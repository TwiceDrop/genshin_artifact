...
const ARATAKI_ITTO_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    internal_name: "Itto",
    element: Element::Geo,
    hp: [1001, 2579, 3455, 5170, 5779, 6649, 7462, 8341, 8951, 9838, 10448, 11345, 11954, 12858, 13772],
    atk: [18, 46, 61, 91, 102, 117, 132, 147, 158, 174, 185, 200, 211, 227, 278],
    def: [75, 194, 258, 386, 431, 496, 557, 622, 668, 734, 779, 846, 892, 959, 1027],
