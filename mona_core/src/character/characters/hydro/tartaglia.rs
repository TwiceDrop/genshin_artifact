...
pub const TARTAGLIA_STATIC_DATA: CharacterStaticData = CharacterStaticData {
    ...
    hp: [1020, 2646, 3521, 5268, 5889, 6776, 7604, 8500, 9121, 10025, 10647, 11561, 12182, 13103, 14034],
    atk: [23, 61, 81, 121, 135, 156, 175, 195, 210, 231, 245, 266, 280, 301, 369],
    def: [63, 165, 219, 328, 366, 421, 473, 528, 567, 623, 662, 719, 757, 815, 873],
