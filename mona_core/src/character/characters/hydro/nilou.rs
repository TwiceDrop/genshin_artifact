...
impl CharacterTrait for Nilou {
    const STATIC_DATA: CharacterStaticData = CharacterStaticData {
        ...
        hp: [1182, 3066, 4080, 6105, 6825, 7852, 8813, 9850, 10571, 11618, 12338, 13397, 14117, 15185, 16264],
        atk: [18, 46, 62, 92, 103, 119, 133, 149, 160, 176, 187, 203, 213, 230, 281],
        def: [57, 147, 196, 293, 327, 377, 423, 473, 507, 557, 592, 643, 677, 729, 780],
